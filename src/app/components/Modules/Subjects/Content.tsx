...
const SubjectModuleContent = ({ 
  ...
  const fetchMoreResources = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/subjects/resources?subject_name=${encodeURIComponent(subjectName)}&page=${nextPage}&sort_by=${encodeURIComponent(sortBy)}`);
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      >
        {loading && (
          <Spin tip="Loading more resources..." />
        )}
        {!loading && hasMore && (
